...
class WorkOrder(generic.BO):
    ...
    refer = models.ForeignKey("self",verbose_name=_("refer wo"),blank=True,null=True, on_delete=models.DO_NOTHING)
    ...
    service = models.ForeignKey(Material,verbose_name=_("service name"),null=True,blank=True,limit_choices_to={"is_virtual":"1"}, on_delete=models.DO_NOTHING)
    project = models.ForeignKey(Project,verbose_name=_("project"),null=True,blank=True, on_delete=models.DO_NOTHING)
...
class WOExtraValue(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,verbose_name=_("workorder"), on_delete=models.DO_NOTHING)
    param_name = models.ForeignKey(ExtraParam,verbose_name=_("extra param"), on_delete=models.DO_NOTHING)
...
class WOItem(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,verbose_name=_("workorder"), on_delete=models.DO_NOTHING)
    material = models.ForeignKey(Material,verbose_name=_("material"),null=True,blank=True,limit_choices_to={"is_virtual":"0"}, on_delete=models.DO_NOTHING)
...
class Loan(generic.BO):
    ...
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_120)
    description = models.TextField(_("description"),blank=True,null=True)
    project = models.ForeignKey(Project,verbose_name=_("project"), on_delete=models.DO_NOTHING)
    user = models.ForeignKey(User,verbose_name=_("user"),blank=True,null=True, on_delete=models.DO_NOTHING)
...
class Reimbursement(generic.BO):
    ...
    description = models.TextField(_("description"),blank=True,null=True)
    project = models.ForeignKey(Project,verbose_name=_("project"), on_delete=models.DO_NOTHING)
    wo = models.ForeignKey(WorkOrder,verbose_name=_("work order"),null=True,blank=True, on_delete=models.DO_NOTHING)
    user = models.ForeignKey(User,verbose_name=_("user"),blank=True,null=True, on_delete=models.DO_NOTHING)
    org = models.ForeignKey(OrgUnit,verbose_name=_("cost center"),blank=True,null=True, on_delete=models.DO_NOTHING)
    ...
    loan = models.ForeignKey(Loan,verbose_name=_("loan record"),blank=True,null=True, on_delete=models.DO_NOTHING)
    loan_amount = models.DecimalField(_("loan amount"),max_digits=10,decimal_places=2,blank=True,null=True)
    logout_amount = models.DecimalField(_("logout amount"),max_digits=10,decimal_places=2,blank=True,null=True)
...
class ReimbursementItem(models.Model):
    ...
    """
    import datetime
    reimbursement = models.ForeignKey(Reimbursement,verbose_name=_("reimbursement"), on_delete=models.DO_NOTHING)
    expense_account = models.ForeignKey(ExpenseAccount,verbose_name=_("expenses account"), on_delete=models.DO_NOTHING)
...
class Activity(generic.BO):
    ...
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_120)
    parent = models.ForeignKey('self',verbose_name=_("parent"),blank=True,null=True, on_delete=models.DO_NOTHING)
    description = models.TextField(_("description"),blank=True,null=True)
    ...
    room = models.ForeignKey(Material,verbose_name=_("room"),blank=True,null=True,limit_choices_to={'tp':20}, on_delete=models.DO_NOTHING)
