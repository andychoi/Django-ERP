    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.activity', verbose_name='parent')),
                ('room', models.ForeignKey(blank=True, limit_choices_to={'tp': 20}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.material', verbose_name='room')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.project', verbose_name='project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_time', models.DateTimeField(blank=True, null=True, verbose_name='pay time')),
                ('pay_user', models.CharField(blank=True, max_length=40, null=True, verbose_name='pay user')),
                ('loan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.loan', verbose_name='loan record')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='organ.orgunit', verbose_name='cost center')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.project', verbose_name='project')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.workorder', verbose_name='refer wo')),
                ('service', models.ForeignKey(blank=True, limit_choices_to={'is_virtual': '1'}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.material', verbose_name='service name')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workorder', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.workorder', verbose_name='workorder')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('param_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.extraparam', verbose_name='extra param')),
                ('workorder', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.workorder', verbose_name='workorder')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_account', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.expenseaccount', verbose_name='expenses account')),
                ('reimbursement', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.reimbursement', verbose_name='reimbursement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.activity')),
