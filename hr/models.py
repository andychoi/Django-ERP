...
class Entry(generic.BO):
    ...
    guider = models.ForeignKey(Employee,verbose_name=_("guider"), on_delete=models.DO_NOTHING)
    position = models.ForeignKey(Position,verbose_name = _('designate position'), on_delete=models.DO_NOTHING)
...
class EmployeeSalaryItem(models.Model):
    ...
    """
    entry = models.ForeignKey(Entry,verbose_name=_("employee entry"), on_delete=models.DO_NOTHING)
    employee = models.ForeignKey(Employee,verbose_name=_("employee"),blank=True,null=True, on_delete=models.DO_NOTHING)
    salary_item = models.ForeignKey(SalaryItem,verbose_name=_("salary item"), on_delete=models.DO_NOTHING)
...
class Transfer(generic.BO):
    ...
    人员调动
    """
    employee = models.ForeignKey(Employee,verbose_name=_("employee"), on_delete=models.DO_NOTHING)
