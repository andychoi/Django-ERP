...
class Inventory(generic.BO):
    ...
    """
    index_weight = 1
    org = models.ForeignKey(Organization,verbose_name=_("organization"),blank=True,null=True, on_delete=models.DO_NOTHING)
    warehouse = models.ForeignKey(Warehouse,verbose_name=_("warehouse"), on_delete=models.DO_NOTHING)
    material = models.ForeignKey(Material,verbose_name=_("material"), on_delete=models.DO_NOTHING)
    measure = models.ForeignKey(Measure,verbose_name=_("measure"), on_delete=models.DO_NOTHING)
            ...
            with transaction.atomic():
                for code,name,description,unit_code,unit_name,warehouse_code,warehouse_name,price,cnt in reader:
                    ...
                    try:
                        ...
                        measure = Measure.objects.create(code=unit_code,name=force_str(unit_name.decode('gbk')))

                    try:
                        house = Warehouse.objects.get(code=warehouse_code)
                    except Exception as e:
                        house = Warehouse.objects.create(code=warehouse_code,name=force_str(warehouse_name.decode('gbk')))

                    try:
                        material = Material.objects.get(code=code)
                    except Exception as e:
                        material = Material(code=code,name=force_str(name.decode('gbk')),spec=force_str(description.decode('gbk')),warehouse=house)
...
class StockIn(generic.BO):
    ...
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
    po = models.ForeignKey(PurchaseOrder,verbose_name=_("purchase order"),null=True,limit_choices_to={"entry_status":"0"},blank=True, on_delete=models.DO_NOTHING)
...
class StockOut(generic.BO):
    ...
    org = models.ForeignKey(Organization,verbose_name=_("organization"),blank=True,null=True, on_delete=models.DO_NOTHING)
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_40)
    project = models.ForeignKey(Project,verbose_name=_("project"),blank=True,null=True, on_delete=models.DO_NOTHING)
    wo = models.ForeignKey(WorkOrder,verbose_name=_("work order"),blank=True,null=True, on_delete=models.DO_NOTHING)
    description = models.TextField(_("description"),blank=True,null=True)
    amount = models.DecimalField(_("money of amount"),max_digits=14,decimal_places=4,blank=True,null=True)
    user = models.ForeignKey(User,verbose_name=_("out user"),blank=True,null=True, on_delete=models.DO_NOTHING)
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
...
class WareReturn(generic.BO):
    ...
    org = models.ForeignKey(Organization,verbose_name=_("organization"),blank=True,null=True, on_delete=models.DO_NOTHING)
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_40)
    out = models.ForeignKey(StockOut,verbose_name=_('StockOut'), on_delete=models.DO_NOTHING)
    amount = models.DecimalField(_("money of amount"),max_digits=14,decimal_places=4,blank=True,null=True)
    user = models.ForeignKey(User,verbose_name=_("out user"),blank=True,null=True, on_delete=models.DO_NOTHING)
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
...
class InOutDetail(models.Model):
    ...
    warehouse = models.ForeignKey(Warehouse,verbose_name=_("warehouse"),blank=True,null=True, on_delete=models.DO_NOTHING)
    material = models.ForeignKey(Material,verbose_name=_("material"),limit_choices_to={"is_virtual":"0"},blank=True,null=True, on_delete=models.DO_NOTHING)
    measure = models.ForeignKey(Measure,verbose_name=_("measure"),blank=True,null=True, on_delete=models.DO_NOTHING)
...
class InItem(InOutDetail):
    ...
    po_item = models.ForeignKey(POItem, on_delete=models.CASCADE,verbose_name=_("po item"),blank=True,null=True)
...
class OutItem(InOutDetail):
    ...
    inventory = models.ForeignKey(Inventory, on_delete=models.CASCADE,blank=True,null=True,verbose_name=_("inventory material"))
...
class ReturnItem(InOutDetail):
    ...
    out_item = models.ForeignKey(OutItem, on_delete=models.CASCADE,blank=True,null=True,verbose_name=_('out item'))
