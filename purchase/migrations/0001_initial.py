    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(limit_choices_to={'partner_type': 'S'}, on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.partner', verbose_name='partner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(limit_choices_to={'is_virtual': '0'}, on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.material', verbose_name='material')),
                ...
                ('po', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='purchase.purchaseorder', verbose_name='purchase order')),
                ('woitem', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='selfhelp.woitem', verbose_name='wo item')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.bankaccount', verbose_name='bank account')),
                ('org', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='organ.organization', verbose_name='organization')),
                ('partner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='basedata.partner', verbose_name='partner')),
                ('po', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='purchase.purchaseorder', verbose_name='purchase order')),
            ],
            options={
