...
class ValueList(generic.BO):
    ...
    module = models.ForeignKey(Module,verbose_name=_("module"),blank=True,null=True, on_delete=models.DO_NOTHING)
    ...
    locked_by = models.ForeignKey(User,verbose_name=_("locked by"),blank=True,null=True, on_delete=models.DO_NOTHING)
...
class ValueListItem(models.Model):
    ...
    值列表项
    """
    group = models.ForeignKey(ValueList,verbose_name=_("list group"), on_delete=models.DO_NOTHING)
...
class Partner(generic.BO):
    ...
    org = models.ForeignKey(Organization, on_delete=models.CASCADE,verbose_name=_("organization"),blank=True,null=True)
...
class BankAccount(generic.BO):
    ...
    partner = models.ForeignKey(Partner, on_delete=models.CASCADE,verbose_name=_("partner"),blank=True,null=True)
    org = models.ForeignKey(Organization, on_delete=models.CASCADE,verbose_name=_("organization"),blank=True,null=True)
...
class Project(generic.BO):
    ...
    partner = models.ForeignKey(Partner, on_delete=models.CASCADE,blank=True,null=True,verbose_name=_("partner"),limit_choices_to={"partner_type":"C"})
...
class Brand(models.Model):
    ...
    """
    index_weight = 101
    trade = models.ForeignKey(Trade, on_delete=models.CASCADE,verbose_name=_("trade"),null=True,blank=True)
    name = models.CharField(_("name"),max_length=const.DB_CHAR_NAME_120)
    pinyin = models.CharField(_("pinyin"),max_length=const.DB_CHAR_NAME_120,blank=True,null=True)
...
class TechnicalParameterName(models.Model):
    ...
    """
    index_weight = 7
    category = models.ForeignKey(Category, on_delete=models.CASCADE,verbose_name=_("material category"))
    name = models.CharField(_("name"),max_length=const.DB_CHAR_NAME_40)
    status = models.BooleanField(_("in use"),default=True)
...
class TechnicalParameterValue(models.Model):
    ...
    """
    tech_name = models.ForeignKey(TechnicalParameterName, on_delete=models.CASCADE,verbose_name=_("technical name"))
...
class Material(generic.BO):
    ...
    warehouse = models.ForeignKey(Warehouse, on_delete=models.CASCADE,blank=True,null=True,verbose_name=_("warehouse"))
...
class MaterialParam(models.Model):
    ...
    param_name = models.ForeignKey(TechnicalParameterName, on_delete=models.CASCADE,blank=Trade,null=True)
...
class Employee(generic.BO):
    ...
    phone = models.CharField(_("phone"),max_length=const.DB_CHAR_NAME_20,blank=True,null=True)
    organization = models.ForeignKey(Organization, on_delete=models.CASCADE,verbose_name = _('organization'),null=True,blank=True)
...
class DataImport(generic.BO):
    ...
    description = models.TextField(_('description'),blank=True,null=True)
    content_type = models.ForeignKey(ContentType, on_delete=models.CASCADE,verbose_name=_("content type"),limit_choices_to={"app_label__in":['basedata','organ','auth']})
