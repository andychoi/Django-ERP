    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'app_label__in': ['basedata', 'organ']}, on_delete=django.db.models.deletion.DO_NOTHING, to='contenttypes.contenttype', verbose_name='content type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modal', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='workflow.modal', verbose_name='workflow model')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inst', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='workflow.instance', verbose_name='workflow instance')),
                ('node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='workflow.node', verbose_name='current node')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='handler')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inst', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='workflow.instance', verbose_name='workflow instance')),
                ('node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='workflow.node', verbose_name='workflow node')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL, verbose_name='submitter')),
            ],
            options={
