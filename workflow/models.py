...
class Modal(models.Model):
    ...
    content_type = models.ForeignKey(ContentType,verbose_name=_("content type"),limit_choices_to={"app_label__in":['basedata','organ']}, on_delete=models.DO_NOTHING)
...
class Node(models.Model):
    ...
    index_weight = 2
    modal = models.ForeignKey(Modal,verbose_name=_("workflow model"), on_delete=models.DO_NOTHING)
...
class Instance(models.Model):
    ...
    starter = models.ForeignKey(User,verbose_name=_("start user"),related_name="starter", on_delete=models.DO_NOTHING)
...
class History(models.Model):
    ...
    index_weight = 5
    inst = models.ForeignKey(Instance,verbose_name=_("workflow instance"), on_delete=models.DO_NOTHING)
    node = models.ForeignKey(Node,verbose_name=_("workflow node"),blank=True,null=True, on_delete=models.DO_NOTHING)
    user = models.ForeignKey(User,verbose_name=_("submitter"), on_delete=models.DO_NOTHING)
...
class TodoList(models.Model):
    ...
    inst = models.ForeignKey(Instance,verbose_name=_("workflow instance"), on_delete=models.DO_NOTHING)
    node = models.ForeignKey(Node,verbose_name=_("current node"),blank=True,null=True, on_delete=models.DO_NOTHING)
    app_name = models.CharField(_("app name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
    model_name = models.CharField(_("model name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
    user = models.ForeignKey(User,verbose_name=_("handler"), on_delete=models.DO_NOTHING)
