...
class Module(generic.BO):
    ...
    parent = models.ForeignKey('self',blank=True,null=True,verbose_name=_("parent"), on_delete=models.DO_NOTHING)   #FIXME
...
class Menu(generic.BO):
    ...
    """
    index_weight = 3
    module = models.ForeignKey(Module,verbose_name=_("module"), on_delete=models.DO_NOTHING)
...
class Role(generic.BO):
    ...
    status = models.BooleanField(_("in use"),default=True)
    parent = models.ForeignKey('self',blank=True,null=True,verbose_name=_("parent"), on_delete=models.DO_NOTHING)
