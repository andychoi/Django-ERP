    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_type', models.CharField(choices=[('10', '普通发票'), ('20', '增值税专用发票'), ('30', '专业发票')], default='10', max_length=6, verbose_name='invoice type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material', models.ForeignKey(blank=True, limit_choices_to={'can_sale': '1', 'is_virtual': '0'}, null=True, on_delete=django.db.models.deletion.CASCADE, to='basedata.material', verbose_name='material')),
