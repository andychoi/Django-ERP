...
class SaleOrder(generic.BO):
    ...
    partner = models.ForeignKey(Partner, on_delete=models.CASCADE,verbose_name=_("partner"),limit_choices_to={"partner_type":"C"})
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE,verbose_name=_("sales man"),blank=True,null=True)
...
class SaleItem(models.Model):
    ...
    material = models.ForeignKey(Material, on_delete=models.CASCADE,verbose_name=_("material"),limit_choices_to={"is_virtual":"0",'can_sale':'1'},blank=True,null=True)
    measure = models.ForeignKey(Measure, on_delete=models.CASCADE,verbose_name=_("measure"),blank=True,null=True)
...
class PaymentCollection(generic.BO):
    ...
    so = models.ForeignKey(SaleOrder, on_delete=models.CASCADE,verbose_name=_("sale order"))
    ...
    bank = models.ForeignKey(BankAccount, on_delete=models.CASCADE,verbose_name=_("bank account"),blank=True,null=True)
...
class OfferSheet(generic.BO):
    ...
    amount = models.DecimalField(_("money amount"),max_digits=12,decimal_places=2,blank=True,null=True,default=0.00)
    discount_amount = models.DecimalField(_("discount amount"),max_digits=12,decimal_places=2,blank=True,null=True,default=0.00)
    user = models.ForeignKey(User, on_delete=models.CASCADE,verbose_name=_("offer man"),blank=True,null=True)
